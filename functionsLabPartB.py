# Problem 5: Using Default Parameters
...
# Problem 6: Variable-Length Arguments (*args) and multiple returns
...
# Problem 7: Variable-Length Arguments (*args) with Keyword argument
